...
#
# owm_city_list_json_path - path to the file city.list.json and customized.city.list.json used to get 
#                           city_id used in api query
#                         - requests.get(owm_url_weather, params ={'id': city_id, 'APPID': owm_APIKEY})
#
...
owm_city_list_json_path = 'C:\\Users\\Aaron\\python scripts\\Projects\\WeatherReport\\city.list.json\\'
